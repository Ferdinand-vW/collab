...
(function(exports) {
  ...
  var unsafeToDateTime = function (s) {
      return Control_Monad_Eff_Unsafe.unsafePerformEff(function __do() {
          ...
          return __unused()((function () {
              var v1 = Data_JSDate.toDateTime(v);
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(v1.value0);
              };
              throw new Error("Failed pattern match at Main line 134, column 19 - line 135, column 23: " + [ v1.constructor.name ]);
          })())();
      });
  };
  var showRoom = new Data_Show.Show(function (v) {
      return "Roomy " + (Data_Show.show(Data_Show.showInt)(v.value0.rid) + (" " + Data_Show.show(Data_Show.showInt)(v.value0.uid)));
  });
  var render = function (state) {
      ...
      })) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(CreateRoom.create)) ])([ Halogen_HTML_Core.text("create") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(JoinRoom.create)) ])([ Halogen_HTML_Core.text("join room") ]) ]);
  };
  ...
  var joinRoom = function (dictMonadEff) {
      return function (dictShow) {
          return function (rid) {
              return Control_Monad_Eff_Class.liftEff(dictMonadEff)(navigateTo("/room/" + Data_Show.show(dictShow)(rid)));
          };
      };
  };
  var decodeJsonRoom = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("rid"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("created"))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("name"))(function (v3) {
                      var cr = unsafeToDateTime(v2);
  ...
  var createRoom = Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableJson)((function () {
      var $37 = {};
      for (var $38 in Network_HTTP_Affjax.defaultRequest) {
          if ({}.hasOwnProperty.call(Network_HTTP_Affjax.defaultRequest, $38)) {
              $37[$38] = Network_HTTP_Affjax["defaultRequest"][$38];
          };
      };
      $37.url = "/api/create/room/";
      $37.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
      return $37;
  })()))(function (v) {
      ...
      throw new Error("Failed pattern match at Main line 102, column 3 - line 104, column 61: " + [ v1.constructor.name ]);
  });
  var $$eval = function (v) {
      if (v instanceof RoomId) {
          ...
          if (v.value0 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0.value0))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.logShow(Data_Show.showInt)(v.value0.value0)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          throw new Error("Failed pattern match at Main line 86, column 5 - line 91, column 18: " + [ v.value0.constructor.name ]);
      };
      if (v instanceof CreateRoom) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
              var v1 = Control_Monad_Aff.launchAff(createRoom)();
              return Data_Unit.unit;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
          });
      };
      if (v instanceof JoinRoom) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(joinRoom(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showInt)(v1))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          });
      };
      throw new Error("Failed pattern match at Main line 84, column 8 - line 98, column 14: " + [ v.constructor.name ]);
  };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.selectElement(Data_Newtype.wrap(DOM_Node_ParentNode.newtypeQuerySelector)("#container")))(function (v) {
          ...
          if (v instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(createRoomForm)(Data_Unit.unit)(v.value0))(function (v1) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
              });
          };
          throw new Error("Failed pattern match at Main line 42, column 3 - line 44, column 62: " + [ v.constructor.name ]);
      });
  }));
  ...
  exports["unsafeToDateTime"] = unsafeToDateTime;
