...
(function(exports) {
              ...
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("m"))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("s"))(function (v3) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("ml"))(function (v4) {
                          ...
                          throw new Error("Failed pattern match at Index.IndexForm line 183, column 5 - line 185, column 26: " + [ mtime.constructor.name ]);
                      });
                  });
              });
          });
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("year"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("month"))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("day"))(function (v3) {
                      ...
                      throw new Error("Failed pattern match at Index.IndexForm line 166, column 5 - line 168, column 30: " + [ mdate.constructor.name ]);
                  });
              });
          });
      });
  ...
  var joinRoom = function (name) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableJson)((function () {
          ...
          for (var $78 in Network_HTTP_Affjax.defaultRequest) {
              if ({}.hasOwnProperty.call(Network_HTTP_Affjax.defaultRequest, $78)) {
                  $77[$78] = Network_HTTP_Affjax["defaultRequest"][$78];
              };
          };
          $77.url = "api/get/room/name/" + name;
          $77.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
          return $77;
      })()))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(Data_Show.show(Data_Argonaut_Core.showJson)(v.response))))(function () {
              ...
              throw new Error("Failed pattern match at Index.IndexForm line 115, column 3 - line 120, column 1: " + [ v1.constructor.name ]);
          });
      });
  };
  var createRoom = function (name) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableJson)((function () {
          var $85 = {};
          for (var $86 in Network_HTTP_Affjax.defaultRequest) {
              if ({}.hasOwnProperty.call(Network_HTTP_Affjax.defaultRequest, $86)) {
                  $85[$86] = Network_HTTP_Affjax["defaultRequest"][$86];
              };
          };
          $85.url = "/api/create/room/" + name;
          $85.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
          return $85;
      })()))(function (v) {
          ...
          throw new Error("Failed pattern match at Index.IndexForm line 107, column 3 - line 111, column 1: " + [ v1.constructor.name ]);
      });
  };
  var $$eval = function (fi) {
      ...
      throw new Error("Failed pattern match at Index.IndexForm line 88, column 11 - line 102, column 14: " + [ fi.constructor.name ]);
  };
...
})(PS["Index.IndexForm"] = PS["Index.IndexForm"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Index_IndexForm = PS["Index.IndexForm"];
  var Network_HTTP_Affjax = PS["Network.HTTP.Affjax"];
  var Partial_Unsafe = PS["Partial.Unsafe"];
  var Prelude = PS["Prelude"];        
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.selectElement(Data_Newtype.wrap(DOM_Node_ParentNode.newtypeQuerySelector)("#container")))(function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.error("Could not find anything"));
          };
          if (v instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Index_IndexForm.indexPageForm)(Data_Unit.unit)(v.value0))(function (v1) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
              });
          };
          throw new Error("Failed pattern match at Index.Main line 44, column 3 - line 46, column 57: " + [ v.constructor.name ]);
      });
  }));
  exports["main"] = main;
})(PS["Index.Main"] = PS["Index.Main"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  ...
  var DOM = PS["DOM"];
  var Halogen_Aff = PS["Halogen.Aff"];
  var Index_Main = PS["Index.Main"];
  var Network_HTTP_Affjax = PS["Network.HTTP.Affjax"];
  var Prelude = PS["Prelude"];        
  var main = Index_Main.main;
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
