...
(function(exports) {
  ...
  var createRoom = Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableJson)((function () {
      var $34 = {};
      for (var $35 in Network_HTTP_Affjax.defaultRequest) {
          if ({}.hasOwnProperty.call(Network_HTTP_Affjax.defaultRequest, $35)) {
              $34[$35] = Network_HTTP_Affjax["defaultRequest"][$35];
          };
      };
      $34.url = "/api/create/room/";
      $34.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
      return $34;
  })()))(function (v) {
      ...
      throw new Error("Failed pattern match at Index.IndexForm line 100, column 3 - line 102, column 61: " + [ v1.constructor.name ]);
  });
  var $$eval = function (fi) {
      if (fi instanceof CreateRoom) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
              var v = Control_Monad_Aff.launchAff(createRoom)();
      ...
      if (fi instanceof JoinRoom) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(joinRoom(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showInt)(v))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(fi.value0);
              });
          });
      };
      throw new Error("Failed pattern match at Index.IndexForm line 81, column 11 - line 88, column 14: " + [ fi.constructor.name ]);
  };
