...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];        
  var TimeNT = (function () {
      function TimeNT(value0) {
          this.value0 = value0;
      };
      TimeNT.create = function (value0) {
          return new TimeNT(value0);
      };
      return TimeNT;
  })();
  var Room = (function () {
      function Room(value0) {
          this.value0 = value0;
      };
      Room.create = function (value0) {
          return new Room(value0);
      };
      return Room;
  })();
  var JoinRoom = (function () {
      function JoinRoom(value0) {
          this.value0 = value0;
      };
      JoinRoom.create = function (value0) {
          return new JoinRoom(value0);
      };
      return JoinRoom;
  })();
  var JoinRoomInput = (function () {
      function JoinRoomInput(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      JoinRoomInput.create = function (value0) {
          return function (value1) {
              return new JoinRoomInput(value0, value1);
          };
      };
  ...
  var CreateRoomInput = (function () {
      function CreateRoomInput(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      CreateRoomInput.create = function (value0) {
          return function (value1) {
              return new CreateRoomInput(value0, value1);
          };
      };
      return CreateRoomInput;
  })();
  var DateTimeNT = (function () {
      function DateTimeNT(value0) {
          this.value0 = value0;
      };
      DateTimeNT.create = function (value0) {
          return new DateTimeNT(value0);
      };
      return DateTimeNT;
  })();
  var DateNT = (function () {
      function DateNT(value0) {
          this.value0 = value0;
      };
      DateNT.create = function (value0) {
          return new DateNT(value0);
      };
      return DateNT;
  })();
  var render = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("form-group") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("input-group") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_("form-control"), Halogen_HTML_Properties.placeholder("Enter a room number"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(JoinRoomInput.create)) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("input-group-btn") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-default btn-block"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonSubmit.value), Halogen_HTML_Events.onClick(Data_Function["const"](Data_Maybe.Just.create(new JoinRoom(Data_Unit.unit)))) ])([ Halogen_HTML_Core.text("Enter room") ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("input-group") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_("form-control"), Halogen_HTML_Properties.placeholder("Enter a room number"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(CreateRoomInput.create)) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("input-group-btn") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-default btn-block"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonSubmit.value), Halogen_HTML_Events.onClick(Data_Function["const"](Data_Maybe.Just.create(new CreateRoom(Data_Unit.unit)))) ])([ Halogen_HTML_Core.text("Create room") ]) ]) ]) ]);
  };
  var navigateTo = function (path) {
      return function __do() {
          var v = DOM_HTML.window();
          var v1 = DOM_HTML_Window.location(v)();
          return DOM_HTML_Location.replace(path)(v1)();
      };
  };
  var decodeJsonTimeNT = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("h"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("m"))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("s"))(function (v3) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("ml"))(function (v4) {
                          var mtime = Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Enum.toEnum(Data_Time_Component.boundedEnumHour)(v1))(function (v5) {
                              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Enum.toEnum(Data_Time_Component.boundedEnumMinute)(v2))(function (v6) {
                                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Enum.toEnum(Data_Time_Component.boundedEnumSecond)(v3))(function (v7) {
                                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Enum.toEnum(Data_Time_Component.boundedEnumMillisecond)(v4))(function (v8) {
                                          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(TimeNT.create(Data_Time.setHour(v5)(Data_Time.setMinute(v6)(Data_Time.setSecond(v7)(Data_Time.setMillisecond(v8)(Data_Bounded.bottom(Data_Time.boundedTime)))))));
                                      });
                                  });
                              });
                          });
                          if (mtime instanceof Data_Maybe.Nothing) {
                              return new Data_Either.Left("Failed to parse Time");
                          };
                          if (mtime instanceof Data_Maybe.Just) {
                              return new Data_Either.Right(mtime.value0);
                          };
                          throw new Error("Failed pattern match at Component.IndexForm line 189, column 5 - line 191, column 26: " + [ mtime.constructor.name ]);
                      });
                  });
              });
          });
  ...
  var decodeJsonDateNT = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("year"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("month"))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("day"))(function (v3) {
                      var mdate = Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Enum.toEnum(Data_Date_Component.boundedEnumYear)(v1))(function (v4) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Enum.toEnum(Data_Date_Component.boundedEnumMonth)(v2))(function (v5) {
                              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Enum.toEnum(Data_Date_Component.boundedEnumDay)(v3))(function (v6) {
                                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(DateNT.create(Data_Date.canonicalDate(v4)(v5)(v6)));
                              });
                          });
                      });
                      if (mdate instanceof Data_Maybe.Nothing) {
                          return new Data_Either.Left("Could not parse date");
                      };
                      if (mdate instanceof Data_Maybe.Just) {
                          return new Data_Either.Right(mdate.value0);
                      };
                      throw new Error("Failed pattern match at Component.IndexForm line 172, column 5 - line 174, column 30: " + [ mdate.constructor.name ]);
                  });
              });
          });
      });
  });
  var decodeJsonDateTimeNT = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonDateNT)(v)("date"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonTimeNT)(v)("time"))(function (v2) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(DateTimeNT.create(new Data_DateTime.DateTime(v1.value0, v2.value0)));
              });
          });
      });
  });
  var decodeJsonRoom = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("rid"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("rname"))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonInt))(v)("uid"))(function (v3) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonDateTimeNT)(v)("rcreated"))(function (v4) {
                          return Control_Applicative.pure(Data_Either.applicativeEither)(new Room({
                              rid: v1, 
                              rname: v2, 
                              rcreated: v4.value0, 
                              uid: v3
  ...
  var joinRoom = function (name) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableJson)((function () {
          var $79 = {};
          for (var $80 in Network_HTTP_Affjax.defaultRequest) {
              if ({}.hasOwnProperty.call(Network_HTTP_Affjax.defaultRequest, $80)) {
                  $79[$80] = Network_HTTP_Affjax["defaultRequest"][$80];
              };
          };
          $79.url = "api/get/room/name/" + name;
          $79.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
          return $79;
      })()))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(Data_Show.show(Data_Argonaut_Core.showJson)(v.response))))(function () {
              var v1 = Data_Argonaut_Decode_Class.decodeJson(decodeJsonRoom)(v.response);
              if (v1 instanceof Data_Either.Left) {
                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(v1.value0));
              };
              if (v1 instanceof Data_Either.Right) {
                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(navigateTo("/room/" + (Data_Show.show(Data_Show.showInt)(v1.value0.value0.rid) + "/")));
              };
              throw new Error("Failed pattern match at Component.IndexForm line 121, column 3 - line 126, column 1: " + [ v1.constructor.name ]);
          });
      });
  };
  var createRoom = function (name) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableJson)((function () {
          var $87 = {};
          for (var $88 in Network_HTTP_Affjax.defaultRequest) {
              if ({}.hasOwnProperty.call(Network_HTTP_Affjax.defaultRequest, $88)) {
                  $87[$88] = Network_HTTP_Affjax["defaultRequest"][$88];
              };
          };
          $87.url = "/api/create/room/" + name;
          $87.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
          return $87;
      })()))(function (v) {
          var v1 = Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeJsonInt)(v.response);
          if (v1 instanceof Data_Either.Left) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("could not parse"));
          };
          if (v1 instanceof Data_Either.Right) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(navigateTo("/room/" + (Data_Show.show(Data_Show.showInt)(v1.value0) + "/")));
          };
          throw new Error("Failed pattern match at Component.IndexForm line 113, column 3 - line 117, column 1: " + [ v1.constructor.name ]);
      });
  };
  var $$eval = function (fi) {
      if (fi instanceof CreateRoom) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                  var v1 = Control_Monad_Aff.launchAff(createRoom(v))();
                  return Data_Unit.unit;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(fi.value0);
              });
          });
      };
      if (fi instanceof CreateRoomInput) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(fi.value0))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(fi.value1);
          });
      };
      if (fi instanceof JoinRoom) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Aff.launchAff(joinRoom(v))))(function (v1) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(fi.value0);
              });
          });
      };
      if (fi instanceof JoinRoomInput) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(fi.value0))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(fi.value1);
          });
      };
      throw new Error("Failed pattern match at Component.IndexForm line 94, column 11 - line 108, column 14: " + [ fi.constructor.name ]);
  };
  var indexPageForm = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      initialState: Data_Function["const"](""), 
      render: render, 
      "eval": $$eval, 
      receiver: Data_Function["const"](Data_Maybe.Nothing.value)
  });
  var insertIndexForm = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.selectElement(Data_Newtype.wrap(DOM_Node_ParentNode.newtypeQuerySelector)("#index-form")))(function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Could not find #index-form"));
          };
          if (v instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(indexPageForm)(Data_Unit.unit)(v.value0))(function (v1) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
              });
          };
          throw new Error("Failed pattern match at Component.IndexForm line 39, column 3 - line 41, column 61: " + [ v.constructor.name ]);
      });
  }));
  exports["DateNT"] = DateNT;
  exports["DateTimeNT"] = DateTimeNT;
  exports["JoinRoom"] = JoinRoom;
  exports["JoinRoomInput"] = JoinRoomInput;
  exports["CreateRoom"] = CreateRoom;
  exports["CreateRoomInput"] = CreateRoomInput;
  exports["Room"] = Room;
  exports["TimeNT"] = TimeNT;
  exports["createRoom"] = createRoom;
  exports["indexPageForm"] = indexPageForm;
  exports["insertIndexForm"] = insertIndexForm;
  exports["joinRoom"] = joinRoom;
  exports["navigateTo"] = navigateTo;
  exports["render"] = render;
  exports["decodeJsonRoom"] = decodeJsonRoom;
  exports["decodeJsonDateTimeNT"] = decodeJsonDateTimeNT;
  exports["decodeJsonDateNT"] = decodeJsonDateNT;
  exports["decodeJsonTimeNT"] = decodeJsonTimeNT;
})(PS["Component.IndexForm"] = PS["Component.IndexForm"] || {});
(function(exports) {// module Text.Base64
...
(function(exports) {
  ...
  var LoginFormState = (function () {
      function LoginFormState(value0) {
          this.value0 = value0;
      };
      LoginFormState.create = function (value0) {
          return new LoginFormState(value0);
      };
      return LoginFormState;
  })();
  var Password_Input = (function () {
      function Password_Input(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Password_Input.create = function (value0) {
          return function (value1) {
              return new Password_Input(value0, value1);
          };
      };
      return Password_Input;
  })();
  var UserId_Input = (function () {
      function UserId_Input(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UserId_Input.create = function (value0) {
          return function (value1) {
              return new UserId_Input(value0, value1);
          };
      };
      return UserId_Input;
  })();
  var Login_Submit = (function () {
      function Login_Submit(value0) {
          this.value0 = value0;
      };
      Login_Submit.create = function (value0) {
          return new Login_Submit(value0);
      };
      return Login_Submit;
  })();
  var renderLogout = Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a_([ Halogen_HTML_Core.text("Logout") ]) ]);
  var renderLogin = Halogen_HTML_Elements.form([ Halogen_HTML_Properties.class_("navbar-form navbar-right") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("form-group") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_("form-control"), Halogen_HTML_Properties.placeholder("UserId"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(UserId_Input.create)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputPassword.value), Halogen_HTML_Properties.class_("form-control"), Halogen_HTML_Properties.placeholder("Password"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Password_Input.create)) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonSubmit.value), Halogen_HTML_Properties.class_("btn btn-default"), Halogen_HTML_Events.onClick(Data_Function["const"](Data_Maybe.Just.create(new Login_Submit(Data_Unit.unit)))) ])([ Halogen_HTML_Core.text("Login") ]) ]);
  var render = function (v) {
      if (v.value0.loggedIn) {
          return renderLogout;
      };
      if (Data_Boolean.otherwise) {
          return renderLogin;
      };
      throw new Error("Failed pattern match at Component.LoginForm line 50, column 1 - line 51, column 35: " + [ v.constructor.name ]);
  };
  var login = function (uname) {
      return function (pw) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(uname)))(function () {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableString)((function () {
                  var $13 = {};
                  for (var $14 in Network_HTTP_Affjax.defaultRequest) {
                      if ({}.hasOwnProperty.call(Network_HTTP_Affjax.defaultRequest, $14)) {
                          $13[$14] = Network_HTTP_Affjax["defaultRequest"][$14];
                      };
                  };
                  $13.url = "/api/private/";
                  $13.headers = [ new Network_HTTP_RequestHeader.RequestHeader("Authorization", "Basic " + Text_Base64.encode64(uname + (":" + pw))) ];
                  $13.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
                  return $13;
              })()))(function (v) {
                  var $17 = Data_Eq.notEq(Network_HTTP_StatusCode.eqStatusCode)(v.status)(200);
                  if ($17) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(Data_Show.show(Network_HTTP_StatusCode.showStatusCode)(v.status)));
                  };
                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("success"));
              });
          });
      };
  };
  var $$eval = function (li) {
      if (li instanceof Password_Input) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(LoginFormState.create((function () {
                  var $20 = {};
                  for (var $21 in v.value0) {
                      if ({}.hasOwnProperty.call(v.value0, $21)) {
                          $20[$21] = v["value0"][$21];
                      };
                  };
                  $20.pass = li.value0;
                  ...
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(li.value1);
              });
          });
      };
      if (li instanceof UserId_Input) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(LoginFormState.create((function () {
                  var $27 = {};
      ...
      if (li instanceof Login_Submit) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(new LoginFormState({
                  userid: "", 
                  pass: "", 
                  loggedIn: true
              })))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(login(v.value0.userid)(v.value0.pass)))(function (v1) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(li.value0);
                  });
              });
          });
      };
      throw new Error("Failed pattern match at Component.LoginForm line 84, column 11 - line 97, column 14: " + [ li.constructor.name ]);
  };
  var loginForm = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      initialState: Data_Function["const"](new LoginFormState({
          userid: "", 
          pass: "", 
          loggedIn: false
      })), 
  ...
  var insertLoginForm = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.selectElement(Data_Newtype.wrap(DOM_Node_ParentNode.newtypeQuerySelector)("#login-form")))(function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Could not find #login-form"));
          };
          if (v instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(loginForm)(Data_Unit.unit)(v.value0))(function (v1) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
              });
          };
          throw new Error("Failed pattern match at Component.LoginForm line 30, column 3 - line 32, column 57: " + [ v.constructor.name ]);
      });
  }));
  exports["Password_Input"] = Password_Input;
  exports["UserId_Input"] = UserId_Input;
  exports["Login_Submit"] = Login_Submit;
  exports["LoginFormState"] = LoginFormState;
  exports["insertLoginForm"] = insertLoginForm;
  exports["login"] = login;
  exports["loginForm"] = loginForm;
  exports["render"] = render;
  exports["renderLogin"] = renderLogin;
  exports["renderLogout"] = renderLogout;
})(PS["Component.LoginForm"] = PS["Component.LoginForm"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Component_IndexForm = PS["Component.IndexForm"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  var Control_Monad_Aff_Class = PS["Control.Monad.Aff.Class"];
  ...
  var Network_HTTP_Affjax_Response = PS["Network.HTTP.Affjax.Response"];
  var Prelude = PS["Prelude"];        
  var EnterUserId = (function () {
      function EnterUserId(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      EnterUserId.create = function (value0) {
          return function (value1) {
              return new EnterUserId(value0, value1);
          };
      };
      return EnterUserId;
  })();
  var EnterPassword = (function () {
      function EnterPassword(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      EnterPassword.create = function (value0) {
          return function (value1) {
              return new EnterPassword(value0, value1);
          };
      };
  ...
  var UsernameExists = (function () {
      ...
      UsernameExists.value = new UsernameExists();
      return UsernameExists;
  })();
  var UsernameTooShort = (function () {
      function UsernameTooShort() {

      };
      UsernameTooShort.value = new UsernameTooShort();
      return UsernameTooShort;
  })();
  var PasswordTooShort = (function () {
      function PasswordTooShort() {

      };
      PasswordTooShort.value = new PasswordTooShort();
  ...
  var NotValid = (function () {
      function NotValid(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      NotValid.create = function (value0) {
          return function (value1) {
              return new NotValid(value0, value1);
          };
      };
      return NotValid;
  })();
  ...
  var RFS = (function () {
      ...
      RFS.create = function (value0) {
          return new RFS(value0);
      };
      return RFS;
  })();
  var toFdb_Username = function (s) {
      if (s === "UsernameTooShort") {
          return Data_Either.Right.create(UsernameTooShort.value);
      };
      if (s === "UsernameExists") {
          return Data_Either.Right.create(UsernameExists.value);
      };
      return new Data_Either.Left("Could not parse Fdb_Username");
  };
  var toFdb_Password = function (s) {
      if (s === "PasswordTooShort") {
          return Data_Either.Right.create(PasswordTooShort.value);
      };
      if (s === "BadPassword") {
          return Data_Either.Right.create(BadPassword.value);
      };
      return new Data_Either.Left("Could not parse Fdb_Password");
  };
  var renderInput = function (s) {
      return function (inputType) {
          return function (action) {
              return function (feedback) {
                  var addHasError = (function () {
                      if (Data_Array["null"](feedback)) {
                          return "";
                      };
                      if (Data_Boolean.otherwise) {
                          return " has-error";
                      };
                      throw new Error("Failed pattern match at Component.RegistrationForm line 79, column 5 - line 82, column 1: " + [  ]);
                  })();
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("form-group" + addHasError)) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(s) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(inputType), Halogen_HTML_Properties.class_("form-control"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(action)) ]) ])(feedback));
              };
          };
      };
  };
  var fdb_UsernameToText = function (v) {
      if (v instanceof UsernameTooShort) {
          return "Username length must be at least 6 characters";
      };
      if (v instanceof UsernameExists) {
          return "This username already exists. Please choose a different one";
      };
      throw new Error("Failed pattern match at Component.RegistrationForm line 95, column 1 - line 96, column 1: " + [ v.constructor.name ]);
  };
  var renderFdb_Username = function (fdb) {
      return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("help-block") ])([ Halogen_HTML_Core.text(fdb_UsernameToText(fdb)) ]);
  };
  var renderInputUsername = function (v) {
      return renderInput("Username:")(DOM_HTML_Indexed_InputType.InputText.value)(EnterUserId.create)(Data_Functor.map(Data_Functor.functorArray)(renderFdb_Username)(v.value0.fdb_Username));
  };
  var fdb_PasswordToText = function (v) {
      if (v instanceof PasswordTooShort) {
          return "Password length must be at least 10 characters";
      };
      if (v instanceof BadPassword) {
          return "Password does not satisfy all requirements";
      };
      throw new Error("Failed pattern match at Component.RegistrationForm line 99, column 1 - line 100, column 1: " + [ v.constructor.name ]);
  };
  var renderFdb_Password = function (fdb) {
      return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("help-block") ])([ Halogen_HTML_Core.text(fdb_PasswordToText(fdb)) ]);
  };
  var renderInputPassword = function (v) {
      return renderInput("Password:")(DOM_HTML_Indexed_InputType.InputPassword.value)(EnterPassword.create)(Data_Functor.map(Data_Functor.functorArray)(renderFdb_Password)(v.value0.fdb_Password));
  };
  var render = function (rfs) {
      return Halogen_HTML_Elements.form_([ renderInputUsername(rfs), renderInputPassword(rfs), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputButton.value), Halogen_HTML_Properties.class_("btn btn-default"), Halogen_HTML_Events.onClick(Data_Function["const"](Data_Maybe.Just.create(new Register(Data_Unit.unit)))), Halogen_HTML_Properties.value("Register") ]) ]);
  };
  var decodeJsonIsValid = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("tag"))(function (v1) {
              if (v1 === "Valid") {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(Valid.value);
              };
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonString)))(v)("contents"))(function (v2) {
                  var v3 = Data_Array.take(2)(v2);
                  if (v3.length === 2) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(Data_Functor.map(Data_Functor.functorArray)(toFdb_Username)(v3[0])))(function (v4) {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(Data_Functor.map(Data_Functor.functorArray)(toFdb_Password)(v3[1])))(function (v5) {
                              return Control_Applicative.pure(Data_Either.applicativeEither)(new NotValid(v4, v5));
                          });
                      });
                  };
                  return new Data_Either.Left("Could not parse contents");
              });
          });
      });
  });
  var createAccount = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(v.value0.pass)))(function () {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableJson)((function () {
              var $42 = {};
              for (var $43 in Network_HTTP_Affjax.defaultRequest) {
                  if ({}.hasOwnProperty.call(Network_HTTP_Affjax.defaultRequest, $43)) {
                      $42[$43] = Network_HTTP_Affjax["defaultRequest"][$43];
                  };
              };
              $42.url = "/api/public/create/account/" + (v.value0.userid + ("/" + (v.value0.pass + "/")));
              $42.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
              return $42;
          })()))(function (v1) {
              var v2 = Data_Argonaut_Decode_Class.decodeJson(decodeJsonIsValid)(v1.response);
              if (v2 instanceof Data_Either.Left) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(v2.value0)))(function () {
                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(new NotValid([  ], [  ]));
                  });
              };
              if (v2 instanceof Data_Either.Right) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v2.value0);
              };
              throw new Error("Failed pattern match at Component.RegistrationForm line 127, column 3 - line 131, column 26: " + [ v2.constructor.name ]);
          });
      });
  };
  var $$eval = function (v) {
      if (v instanceof EnterUserId) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(RFS.create((function () {
                  var $52 = {};
                  for (var $53 in v1.value0) {
                      if ({}.hasOwnProperty.call(v1.value0, $53)) {
                          $52[$53] = v1["value0"][$53];
                      };
                  };
                  $52.userid = v.value0;
      ...
      if (v instanceof EnterPassword) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(RFS.create((function () {
                  var $59 = {};
                  for (var $60 in v1.value0) {
                      if ({}.hasOwnProperty.call(v1.value0, $60)) {
                          $59[$60] = v1["value0"][$60];
                      };
                  };
                  $59.pass = v.value0;
      ...
      if (v instanceof Register) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(createAccount(new RFS(v1.value0))))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v2 instanceof Valid) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Component_IndexForm.navigateTo("/")))(function () {
                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("account created"));
                          });
                      };
                      if (v2 instanceof NotValid) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(new RFS({
                              userid: v1.value0.userid, 
                              pass: v1.value0.pass, 
                              fdb_Username: v2.value0, 
                              fdb_Password: v2.value1
                          })))(function () {
                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("invalid account details"));
                          });
                      };
                      throw new Error("Failed pattern match at Component.RegistrationForm line 114, column 3 - line 121, column 3: " + [ v2.constructor.name ]);
                  })())(function () {
      ...
      throw new Error("Failed pattern match at Component.RegistrationForm line 103, column 1 - line 106, column 12: " + [ v.constructor.name ]);
  };
  var registrationForm = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      initialState: Data_Function["const"](new RFS({
          userid: "", 
          pass: "", 
          fdb_Username: [  ], 
          fdb_Password: [  ]
  ...
  var insertRegistrationForm = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.selectElement(Data_Newtype.wrap(DOM_Node_ParentNode.newtypeQuerySelector)("#registration-form")))(function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Could not find #registration-form"));
          };
          if (v instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(registrationForm)(Data_Unit.unit)(v.value0))(function (v1) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
              });
          };
          throw new Error("Failed pattern match at Component.RegistrationForm line 35, column 3 - line 37, column 64: " + [ v.constructor.name ]);
      });
  }));
  exports["PasswordTooShort"] = PasswordTooShort;
  exports["BadPassword"] = BadPassword;
  exports["UsernameExists"] = UsernameExists;
  exports["UsernameTooShort"] = UsernameTooShort;
  exports["NotValid"] = NotValid;
  exports["Valid"] = Valid;
  exports["EnterUserId"] = EnterUserId;
  exports["EnterPassword"] = EnterPassword;
  exports["Register"] = Register;
  exports["RFS"] = RFS;
  exports["createAccount"] = createAccount;
  exports["fdb_PasswordToText"] = fdb_PasswordToText;
  exports["fdb_UsernameToText"] = fdb_UsernameToText;
  exports["insertRegistrationForm"] = insertRegistrationForm;
  exports["registrationForm"] = registrationForm;
  exports["render"] = render;
  exports["renderFdb_Password"] = renderFdb_Password;
  exports["renderFdb_Username"] = renderFdb_Username;
  exports["renderInput"] = renderInput;
  exports["renderInputPassword"] = renderInputPassword;
  exports["renderInputUsername"] = renderInputUsername;
  exports["toFdb_Password"] = toFdb_Password;
  exports["toFdb_Username"] = toFdb_Username;
  exports["decodeJsonIsValid"] = decodeJsonIsValid;
})(PS["Component.RegistrationForm"] = PS["Component.RegistrationForm"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Component_IndexForm = PS["Component.IndexForm"];
  var Component_LoginForm = PS["Component.LoginForm"];
  var Component_RegistrationForm = PS["Component.RegistrationForm"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Control_Monad_Eff_Console = PS["Control.Monad.Eff.Console"];
  var DOM = PS["DOM"];
  ...
  var main = function __do() {
      Component_IndexForm.insertIndexForm();
      Component_LoginForm.insertLoginForm();
      return Component_RegistrationForm.insertRegistrationForm();
  };
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
